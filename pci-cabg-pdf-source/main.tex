% =====================================================================
%  醫病共享決策 — 支架（PCI）還是開刀繞道（CABG）？— Tufte-book 版
...
\vspace{0.7cm}
{\heibold\fontsize{30}{38}\selectfont\color{hfred} 支架，還是開刀繞道手術？}\par
\vspace{0.7cm}
{\hei\large\color{hfslate} 心臟三條血管狹窄，該裝支架（PCI）還是開刀繞道（CABG）？}\par
\vspace{0.3cm}
...
\vspace{0.3cm}
{\hei\normalsize\color{hfslate} 諮詢電話　(03)\,5326151 轉 522010（心導管室）}\par
\vspace{0.8cm}
...
\newthought{心導管支架放置}（經皮冠狀動脈介入治療，PCI）是一種\textbf{侵入性較小}的治療方式。透過導管，從\textbf{手腕或鼠蹊部}的血管進入，送到心臟狹窄的冠狀動脈，先以氣球將狹窄處撐開，再放入\textbf{支架}支撐血管壁，讓血流恢復暢通。\defn{通常當天可完成}{多數情況下 PCI 為局部麻醉、傷口僅約 0.1～0.3 公分，是「微創、恢復快」的處置方式。}
...
\section{手術大致的過程}
繞道手術需\textbf{全身麻醉}，傷口位於\textbf{胸部正中或左側胸}，長約 8～15 公分，手術時間約 4～6 小時（視情況而定）。手術可\textbf{一次處理多條阻塞的血管}，達到較完整的血流重建。
...
\toprule
\heibold\color{hfteal} 項目 & \heibold\color{pciblue} 心導管放置支架（PCI） & \heibold\color{hfred} 開刀繞道手術（CABG）\\
\midrule
麻醉方式 & 局部麻醉。 & 全身麻醉。\\
傷口位置及大小 & 手腕或鼠蹊部，約 0.1～0.3 公分。 & 胸部正中或側胸，傷口大約 8～15 公分。\\
...
\toprule
\heibold\color{pciblue} 心導管支架（PCI） & \heibold\color{hfred} 開刀繞道手術（CABG）\\
\midrule
...
\bigskip
{\hei\large\color{hfteal} ① 我是不是應該選擇「開刀繞道手術（CABG）」？}
\nopagebreak
\begin{fullwidth}
...
\hline
\heibold 重要性 & \heibold 不認同 & \heibold 不很認同 & \heibold 一般 & \heibold 認同 & \heibold 非常認同\\
\hline
我不用擔心復原期的問題，可以休養。 & & & & & \\ \hline
我很擔心醫療費用影響生活。 & & & & & \\ \hline
我想要一次在醫院就把所有的心臟血管處理好。 & & & & & \\ \hline
我知道三條血管狹窄，放支架和開刀繞道手術風險差不多。 & & & & & \\ \hline
我想盡快回復正常運動型態。 & & & & & \\ \hline
我知道開刀繞道手術的長期效果相對優於放置支架。 & & & & & \\ \hline
\end{tabular}
\renewcommand{\arraystretch}{1.0}
\end{fullwidth}

\bigskip
{\hei\large\color{pciblue} ② 我是不是應該選擇「心導管血管支架放置（PCI）」？}
\nopagebreak
\begin{fullwidth}
\renewcommand{\arraystretch}{1.6}
\hei\footnotesize\color{hfslate}
...
把您在意的事再彙整一次。請就以下兩組敘述，分別圈選「是」或「否」。哪一組您回答「是」的項目較多，\textbf{可能}就是目前較貼近您的選項。這只是幫助您整理想法，\textbf{不是最終決定}。

\bigskip
{\hei\large\color{hfred} ① 我打算選擇「開刀繞道手術（CABG）」}
\nopagebreak
\begin{fullwidth}
...
\hline
\heibold 敘述 & \heibold 是 & \heibold 否\\
\hline
我知道要一段時間休養恢復。 & & \\ \hline
醫療費用比較低，我比較負擔得起。 & & \\ \hline
繞道手術可以幫我一次解決三條心臟血管的問題。 & & \\ \hline
我知道三條血管狹窄的情況下，放支架和開刀繞道手術風險差不多。 & & \\ \hline
...
\bigskip
{\hei\large\color{pciblue} ② 我打算選擇「放置支架（PCI）」}
\nopagebreak
\begin{fullwidth}
\renewcommand{\arraystretch}{1.7}
\hei\small\color{hfslate}
...
我知道三條血管狹窄放支架和開刀繞道手術風險差不多。 & & \\ \hline
...
經過前面幾個步驟，您已花了一些時間了解「開刀繞道」與「放支架」的差異，也想過一些會影響決定的因素。現在，請檢視一下自己的準備狀態——\textbf{不論結果如何，都沒有對錯}。
...
\tick\ 外科開刀繞道手術（CABG）\par
\tick\ 內科心導管心臟血管支架放置（PCI）\par
